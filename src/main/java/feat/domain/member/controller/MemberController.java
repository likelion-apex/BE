package feat.domain.member.controller;

import feat.auth.dto.response.MemberResponse;
import feat.common.ApiResponse;
import feat.domain.member.dto.request.NicknameUpdateRequest;
import feat.domain.member.dto.request.ProfileUpdateRequest;
import feat.domain.member.dto.request.SkinConcernsUpdateRequest;
import feat.domain.member.dto.request.SkinTypeUpdateRequest;
import feat.domain.member.service.MemberService;

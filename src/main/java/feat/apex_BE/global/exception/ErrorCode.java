...
public enum ErrorCode {
    ...
    NAVER_SEARCH_FAILED(HttpStatus.BAD_GATEWAY, "PRODUCT-002", "네이버 쇼핑 검색 중 오류가 발생했습니다."),
    ST11_SEARCH_FAILED(HttpStatus.BAD_GATEWAY, "PRODUCT-003", "11번가 상품 검색에 실패했습니다."),
    PRODUCT_DETAIL_FETCH_FAILED(HttpStatus.BAD_GATEWAY, "PRODUCT-004", "상품 상세정보 조회에 실패했습니다."),
    OCR_REQUEST_FAILED(HttpStatus.BAD_GATEWAY, "PRODUCT-005", "이미지 텍스트 인식(OCR) 요청에 실패했습니다.");
